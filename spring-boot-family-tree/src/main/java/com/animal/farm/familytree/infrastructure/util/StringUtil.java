...
import com.animal.farm.familytree.infrastructure.Tuple;
...
public class StringUtil {
   ...
   * @throws Exception
   */
  public static Tuple<String, Integer> splitAuthority(String authority) throws Exception {
    String address = null;
    Integer port = null;
    if (authority.contains(":")) {
      String[] addressAndPort = authority.split(":");
      if (addressAndPort.length != 2) {
        throw new Exception("illegal format:" + authority);
      } else {
        try {
